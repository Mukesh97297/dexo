        ...
        <div className=' bg-gradient-radial'>
            <div className='mx-auto container px-4 py-10'>
                ...
                <div className='col-span-12 text-center'>
                    <span className='font-bold lg:text-[56px] text-4xl leading-10 lg:leading-[64px] text-white' style={{ textShadow: '0px 0px 16px rgba(58, 54, 255, 0.24), 0px 0px 64px rgba(225, 194, 255, 0.48)' }}>The Ultimate DEX</span>
                    <p className='text-[#8F9BB7] font-normal lg:text-2xl text-base text-center'>Trade against zero spread and deep liquidity with <br className='md:block hidden' /> advanced order types such as limit, stop-loss, and <br className='md:block hidden' /> more. Earn fees for providing liquidity in one click</p>
                </div>
                </div>
                <div className='grid grid-cols-12 lg:gap-10 gap-0 py-10'>
                    <div className='lg:col-span-4 col-span-12 lg:py-0 py-5'>
                        <div className='relative border border-solid border-gray-300 border-opacity-[10%] rounded-[20px] justify-center flex  shadow-inner w-full' style={{
                            ...
                            <div className='lg:h-80  h-auto py-[40px] text-center'>
                    ...
                    <div className='lg:col-span-4 col-span-12 lg:py-0 py-5'>
                        <div className=' border border-solid border-gray-300 border-opacity-[10%] rounded-[20px] justify-center flex  shadow-inner w-full'style={{ background: 'linear-gradient(0deg, rgba(180, 182, 208, 0.1), rgba(180, 182, 208, 0.1)), radial-gradient(53.11% 106.23% at 50% 0%, rgba(255, 187, 0, 0.12) 0%, rgba(14, 19, 48, 0) 100%)'}}>
                            <div className='lg:h-80  h-auto py-[40px] text-center'>
                                <div className='flex justify-center'>
                    ...
                    <div className='lg:col-span-4 col-span-12 lg:py-0 py-5'>
                        <div className='relative border border-solid border-gray-300 border-opacity-[10%] rounded-[20px] justify-center flex items-center  shadow-inner w-full'style={{ background: 'radial-gradient(53.11% 106.23% at 50% 0%, rgba(53, 233, 227, 0.12) 0%, rgba(14, 19, 48, 0) 100%), linear-gradient(0deg, rgba(180, 182, 208, 0.1), rgba(180, 182, 208, 0.1))'}}>
                            <div className='lg:h-80  h-auto py-[40px] text-center'>
                                <div className='flex justify-center'>
